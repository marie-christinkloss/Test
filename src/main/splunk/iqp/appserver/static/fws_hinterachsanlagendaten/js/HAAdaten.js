//# sourceURL=fws_hinterachsanlagendaten/js/HAAdaten.js
require([
    "splunkjs/mvc",
    "splunkjs/mvc/utils",
    ...
    function(
        ...
        function createChassisChoices(elem) {
            ...
            var searchQuery = "| inputlookup lkup_hinterachse";
            var searchParams = {
                exec_mode: "blocking"
            };
        ...
        win.on('chassisChoicesCreated', function (e) {
            ...
            var search_filter_options = new SearchManager({
                ...
                "search": "| tstats  \n" +
                    "    count \n" +
                    "  from datamodel=APDM_FWS.Hinterachse \n" +
                    "  where (nodename=Hinterachse) $tok_werk$ \n" +
                    "  groupby source Hinterachse.shortVIN Hinterachse.werk Hinterachse.wheelAlignmentCode Hinterachse.resultName Hinterachse.measureType Hinterachse.pruefumfangName  \n" +
                    "| fields - count \n" +
                    "| eventstats \n" +
                    "    count AS maxEinstellhaeufigkeit \n" +
                    "  by Hinterachse.shortVIN Hinterachse.resultName \n" +
                    "| table source Hinterachse.werk Hinterachse.wheelAlignmentCode Hinterachse.resultName Hinterachse.measureType Hinterachse.pruefumfangName Hinterachse.testStand maxEinstellhaeufigkeit \n" +
                    "| dedup source Hinterachse.werk Hinterachse.wheelAlignmentCode Hinterachse.resultName Hinterachse.measureType Hinterachse.pruefumfangName Hinterachse.testStand maxEinstellhaeufigkeit",
                "sample_ratio": 1,
            ...
            var search_histogram = new SearchManager({
                ...
                "latest_time": "$tok_dt.latest$",
                "search": "| tstats  \n" +
                    "    first(Hinterachse.evaluationMaxValue) AS Hinterachse.evaluationMaxValue \n" +
                    "    first(Hinterachse.evaluationMinValue) AS Hinterachse.evaluationMinValue \n" +
                    "    first(Hinterachse.adjustMaxDbl) AS Hinterachse.adjustMaxDbl \n" +
                    "    first(Hinterachse.adjustMinDbl) AS Hinterachse.adjustMinDbl \n" +
                    "    first(Hinterachse.maxValueDbl) AS Hinterachse.maxValueDbl \n" +
                    "    first(Hinterachse.minValueDbl) AS Hinterachse.minValueDbl \n" +
                    "    first(Hinterachse.desiredValueDbl) AS Hinterachse.desiredValueDbl \n" +
                    "  from datamodel=APDM_FWS.Hinterachse \n" +
                    "  where (nodename=Hinterachse) $tok_werk$ $tok_wheelAlignmentCode$ $tok_fwe$ $tok_pruefumfang$ $tok_teststand$ $tok_messungsart$ \n" +
                    "  groupby _time source Hinterachse.shortVIN Hinterachse.werk Hinterachse.wheelAlignmentCode Hinterachse.resultName Hinterachse.measureType Hinterachse.pruefumfangName Hinterachse.testStand Hinterachse.resultValueDbl Hinterachse.minValueDbl Hinterachse.maxValueDbl \n" +
                    "| rename  \n" +
                    "  Hinterachse.* AS * \n" +
                    "| rename minValueDbl AS minToleranz maxValueDbl AS maxToleranz \n" +
                    "| fields werk testStand wheelAlignmentCode shortVIN resultName resultValueDbl minToleranz maxToleranz \n" +
            ...
            var search_sollIst = new SearchManager({
                ...
                "search": "| tstats  \n" +
                    ...
                    "  Hinterachse.* AS * \n" +
                    "| rename minValueDbl AS minToleranz maxValueDbl AS maxToleranz \n" +
                    "| fields _time werk wheelAlignmentCode shortVIN testStand measureType resultName resultValueDbl minToleranz maxToleranz \n" +
                    "| lookup lkup_werk_input value AS werk OUTPUT werk AS werk\n" +
                    "| lookup lkup_spurcode Spurcode as wheelAlignmentCode OUTPUT Beschreibung AS spurcode \n" +
                    "| eval wheelAlignmentCode=wheelAlignmentCode+ if(isNotNull(spurcode), \" (\"+spurcode+\")\", \"\")\n" +
                    "| sort _time \n" +
            ...
            var search_filter_wheelAlignmentCode = new PostProcessManager({
                ...
                "search": "search $tok_werk$ $tok_pruefumfang$ $tok_teststand$ $tok_messungsart$ | rename Hinterachse.* AS * | fields wheelAlignmentCode | dedup wheelAlignmentCode \n" +
                    "| lookup lkup_spurcode Spurcode as wheelAlignmentCode OUTPUT Beschreibung AS spurcode \n" +
            ...
            var search_filter_resultName = new PostProcessManager({
                ...
                "managerid": "search_filter_options",
                "search": "search $tok_werk$ $tok_pruefumfang$ $tok_teststand$ $tok_messungsart$ | rename Hinterachse.* AS * | fields resultName | dedup resultName \n" +
            ...
            var search_filter_pruefumfangName = new PostProcessManager({
                ...
                "managerid": "search_filter_options",
                "search": "search $tok_werk$ $tok_teststand$ $tok_messungsart$ | rename Hinterachse.* AS * | fields pruefumfangName | dedup pruefumfangName | sort pruefumfangName",
            ...
            var search_filter_testStand = new PostProcessManager({
                ...
                "managerid": "search_filter_options",
                "search": "search $tok_werk$ $tok_pruefumfang$ $tok_messungsart$ | rename Hinterachse.* AS * | fields testStand | dedup testStand | sort testStand",
            ...
            var search_filter_measureType = new PostProcessManager({
                ...
                "managerid": "search_filter_options",
                "search": "search $tok_werk$ $tok_pruefumfang$ $tok_teststand$ | rename Hinterachse.* AS * | fields measureType | dedup measureType | sort measureType",
            ...
            var search_filter_einstellhaeufigkeit = new PostProcessManager({
                ...
                "managerid": "search_filter_options",
                "search": "search $tok_werk$ $tok_pruefumfang$ $tok_teststand$ $tok_messungsart$ | rename Hinterachse.* AS * | stats max(maxEinstellhaeufigkeit) As maxEinstellhaeufigkeit | eval Einstellhaeufigkeit=mvrange(1, maxEinstellhaeufigkeit+1, 1) | fields Einstellhaeufigkeit | mvexpand Einstellhaeufigkeit",
            ...
            var input_wheelalignmentCode = new MultiSelectInput({
                ...
                "labelField": "spurcode",
                "suffix": ")",
                "valuePrefix": "Hinterachse.wheelAlignmentCode=\"*",
            ...
            var input_fwe = new MultiSelectInput({
                ...
                "suffix": ")",
                "valuePrefix": "Hinterachse.resultName=\"",
            ...
            var input_pruefumfangName = new MultiSelectInput({
                ...
                "suffix": ")",
                "valuePrefix": "Hinterachse.pruefumfangName=\"",
            ...
            var input_testStand = new MultiSelectInput({
                ...
                "suffix": ")",
                "valuePrefix": "Hinterachse.testStand=\"",
            ...
            var input_measureType = new MultiSelectInput({
                ...
                "suffix": ")",
                "valuePrefix": "Hinterachse.measureType=\"",
            ...
            var input_groupBy = new DropdownInput({
                ...
                "choices": [
                    ...
                    {"value": "testStand", "label": i18n._("Pruefstand")}
                ],
            ...
            function addSollIst(currDivName, chassisId, currChassisSet, groupByVal) {
                ...
                if (typeof obj == "undefined") {
                    var search_sollIstChart = new PostProcessManager({
                        ...
                        "search": "search resultName=\"" + currChassisSet + "\" " + gbVal + " | stats latest(resultValueDbl) AS \"" + i18n._("Ergebniswert") + "\" by shortVIN UEG OEG",
                        "id": id
                    }, {tokens: true, tokenNamespace: "submitted"});
                }
                ...
                new ChartElement({
                    ...
                    "charting.fieldColors": "{\"OEG\":0xFF0000, \"UEG\":0xFF0000, \"" + i18n._("Ergebniswert") + "\":0x73A550}",
            ...
            excelExportFnc.add_excel_export_button(
                ...
                "  groupby _time source Hinterachse.shortVIN Hinterachse.werk Hinterachse.wheelAlignmentCode Hinterachse.resultName Hinterachse.measureType Hinterachse.pruefumfangName Hinterachse.testStand Hinterachse.resultValueDbl Hinterachse.minValueDbl Hinterachse.maxValueDbl \n" +
                "| rename  \n" +
                "  Hinterachse.* AS * ",  'tok_dt.latest', 'tok_dt.earliest' 
            );
