    ...
    var DockedTableView = TableView.extend({
        ...
        initialize: function() {
            ...
            lazyView.on("loadComplete",function(){
                var tableDock=lazyView.children.vizList.stats.children.wrappedView.children.tableDock;
                ...
                tableDock.syncColumnWidths = function() {
                    ...
                    this.$header.css({right: this.left});
                }
                ...
                tableDock.updateHeaders = function() {
                    ...
                    this.$header = $('<div class="header-table-docked" style="display:none"><table></table><div class="disable"></div></div>').css({top: this.options.offset, left:this.left, right: this.left});
